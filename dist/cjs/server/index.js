...
var require_src = __commonJS((exports2) => {
  ...
  var F = __toModule(require_F());
  var T = __toModule(require_T());
  var _ = __toModule(require__());
  ...
  var clamp = __toModule(require_clamp());
  ...
  var compose = __toModule(require_compose());
  ...
  var is = __toModule(require_is());
  var isEmpty = __toModule(require_isEmpty());
  var isNil = __toModule(require_isNil());
  var join = __toModule(require_join());
  ...
  var merge = __toModule(require_merge());
  ...
  var omit2 = __toModule(require_omit());
  ...
  var paths = __toModule(require_paths());
  ...
  var andThen = __toModule(require_andThen());
  ...
  var toUpper = __toModule(require_toUpper());
  ...
  var update = __toModule(require_update());
  var useWith = __toModule(require_useWith());
  var values = __toModule(require_values());
  ...
  var xor = __toModule(require_xor());
...
var server = __toModule(require("react-dom/server"));

// src/client/ServerSideEffectProvider.jsx
var react = __toModule(require("react"));
var use_ssr = __toModule(require_useSSR());
var ServerSideEffectContext = react.default.createContext({});
...
async function renderToStringWithData(App, cachePath = void 0) {
  try {
    ...
    server.renderToStaticMarkup(/* @__PURE__ */ react2.default.createElement(ServerSideEffectProvider, {
      value: context
    }, App));
    ...
    const markupWithData = server.renderToString(/* @__PURE__ */ react2.default.createElement(ServerSideEffectProvider, {
